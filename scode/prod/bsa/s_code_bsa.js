...
var sVerNum = 'BSA161212'; // BSAYYMMDD
/************************ ADDITIONAL FEATURES ***********************/
/*
var currentURL = window.location.href.toLowerCase();
if (currentURL.indexOf("banksa.com") != -1) {
    var s_account = "stgeorge-banksa-prd"
} else {
    var s_account = "stgeorge-banksa-dev"
}
*/
var s_account = 'stgeorge-banksa-dev';
var isProdSite = (/^(?:www)\.banksa\.com\.au$/i).test(location.hostname);
if (isProdSite) {
    s_account = 'stgeorge-banksa-prd';
...
function s_doPlugins(s) {
    ...
    s.pageName = s.pageName.replace(/:content:sbg:bsa:en/, '');
